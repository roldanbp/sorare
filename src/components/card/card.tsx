        ...
        <div className={namespace} data-testid={namespace}>
            <div className={`${namespace}__club`}>
                <div className={`${namespace}__season`}>
                    <h3 className={`${namespace}__season-name`}>
                        {card.season.name}
                    </h3>
                    <h3 className={`${namespace}__season-serial`}>
                        <span className="stand-out">{card.serialNumber}</span> /
                        100
                    </h3>
                </div>
                <div className={`${namespace}__detail`}>
                    <img
                        className={`${namespace}__detail-img`}
                        src={card.team.pictureUrl}
                        alt="club"
                    />
                    <h3 className={`${namespace}__detail-number`}>
                        {card.shirtNumber}
                    </h3>
                </div>
            </div>
            ...
            />
            <h3 className={`${namespace}__firstname`}>
            ...
            <div className={`${namespace}__player`}>
                <div className={`${namespace}__player-info`}>
                    ...
                    <h3 className={`${namespace}__player-info-content`}>
                        {card.age}
                    </h3>
                </div>
                <div className={`${namespace}__player-info`}>
                    <h3 className={`${namespace}__player-info-title`}>
                        Position
                    </h3>
                    <h3 className={`${namespace}__player-info-content`}>
                        {card.position}
                ...
                <div className={`${namespace}__player-info`}>
                    ...
                    <img
                        className={`${namespace}__player-info-img`}
